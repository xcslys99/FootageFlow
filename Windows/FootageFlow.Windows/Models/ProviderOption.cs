...
public sealed class ProviderOption(string id, string displayName, bool enabled) : ObservableObject
{
    ...
    public bool CanOpenOfficialSearch => Id is "nasa" or "libraryOfCongress" or "nationalArchives" or "europeana" or "peertube" or "videvo" or "videezy" or "mixkit" or "coverr" or "vimeo" or "dailymotion" or "dareful" or "mazwai" or "dvids" or "britishPathe" or "esa";
}
