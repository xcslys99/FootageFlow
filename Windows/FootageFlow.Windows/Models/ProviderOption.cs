...
public sealed class ProviderOption(string id, string displayName, bool enabled) : ObservableObject
{
    ...
    public bool SupportsApiKey => Id is "pexels" or "pixabay" or "youtube" or "nationalArchives" or "europeana";
    public bool CanOpenOfficialSearch => Id is "nasa" or "libraryOfCongress" or "nationalArchives" or "europeana";
}
